...
class FAQSet:
    ...
    FAQ_DATA_SET = {
        '0': {'question': 'Сколько это стоит? И как оплатить?',
              'answer': 'Сутки — 400 рублей. Оплата курьеру — наличными или картой.'},
        '1': {'question': 'Хочу сразу несколько самокатов! Так можно?',
        ...
        '2': {'question': 'Как рассчитывается время аренды?',
